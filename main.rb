...
include LyambdaGem
    ...
    puts "Результат: #{Reducer.to_normal(app).to_s}"
    ...
    puts "Результат: #{Reducer.to_normal(app43).to_s}"
    ...
    puts "Результат: #{Reducer.to_normal(app51).to_s}"
    ...
    puts "Результат: #{Reducer.to_normal(app61).to_s}"
    ...
    puts "Результат: #{Reducer.to_normal(app62).to_s}"
    ...
    puts "Результат: #{Reducer.to_normal(app63).to_s}"
    ...
    puts "Результат: #{Reducer.to_normal(app71).to_s}"
    ...
    puts "Результат: #{Reducer.to_normal(app72).to_s}"
    ...
    puts "Результат: #{Reducer.to_normal(app73).to_s}"
    ...
    puts "Результат: #{Reducer.to_normal(appbeta).to_s}"
